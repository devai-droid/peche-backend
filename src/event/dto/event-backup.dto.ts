...
export interface EventBackupDto {
  categoryId?: string
  detailPageId?: string
...
export class CreateEventBackupDto implements EventBackupDto {
...
export class UpdateEventBackupDto implements EventBackupDto {
  @ApiPropertyOptional() @IsOptional() @IsUUID() readonly categoryId?: string
  @ApiPropertyOptional() @IsOptional() @IsUUID() readonly detailPageId?: string
  @ApiPropertyOptional() @IsOptional() @IsUUID() readonly integratedCrmCategoryId?: string
  @ApiPropertyOptional() @IsOptional() @IsUUID() readonly backupBundleId?: string
...
export class EventBackupList extends Paginated {
  @ApiProperty({ type: EventBackup, isArray: true }) items: EventBackup[]
}
